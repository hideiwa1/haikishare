    ...
    <form class="p-form" action="/store/register" method="post">
        ...
        <div class="p-form__content">
            <p>
                ...
                <input type="text" name="name" placeholder="コンビニ名" class="c-form__text"  value="{{ old('name') }}">
            </p>
            <p>
                <span class="c-form__title">支店名</span>
                <input type="text" name="branch" placeholder="支店名" class="c-form__text"  value="{{ old('branch') }}">
            </p>
            <p>
            ...
            <p>
                <span class="c-form__title">住所（市区町村行こう）</span>
                <input type="text" name="address2" placeholder="住所" class="c-form__text"  value="{{ old('address2') }}">
            </p>
            <p>
